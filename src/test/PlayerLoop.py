...
import threading
import pyaudio
from pydub.utils import make_chunks, _fd_or_path_or_tempfile
...
class PlayerLoop(threading.Thread):
    ...
    def run(self):
        ...
        stream = player.open(
            format=player.get_format_from_width(sound.sample_width),
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(add_help=True,
                                     description="Play a file continously, and exit gracefully on signal")
